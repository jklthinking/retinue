...
class UnmappedChannelUser(IntakeRefused):
    """No ``channel_users`` row binds this sender identity.

    Distinguished from other refusals so an inbound bridge can answer with
    registration guidance instead of treating the message as an error.
    """
