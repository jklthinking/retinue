...
import InternalOperationsPage from "./InternalOperationsPage";
import { Avatar } from "../avatar";
import { Ambient, DataState, PageHeader, Panel } from "../components/ui";

export default function Operations({ internalOn }: { internalOn: boolean }) {
  ...
  return (
    <div className="rt-page operations-page">
      ...
      <Reports />
      {internalOn && <InternalOperationsPage />}
      </>}
    </div>
  );
}
