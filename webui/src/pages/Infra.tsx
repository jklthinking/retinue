...
import type { NodeInfo, NodeRuntimeState, WatermarkLevel } from "../types";
...
const WATERMARK_LABEL: Record<WatermarkLevel, string> = {
  ok: "正常",
  warn: "注意",
  high: "告警",
  critical: "危急",
...
const WATERMARK_CHIP: Record<WatermarkLevel, string> = {
  ok: "chip-low",
  warn: "chip-medium",
  high: "chip-high",
  critical: "chip-urgent",
  unknown: "",
};
