...
import InternalHub from "./pages/InternalHub";
...
const NAV: {
  ...
  { key: "internal", label: "中枢", icon: <Castle size={16} />, internalOnly: true },
...
export default function App() {
  ...
  const internalOn = Boolean(me.site_console) && me.role === "admin";
  ...
  return (
    <div className={`shell ${viewerMode ? "shell--viewer" : ""}`}>
      <aside className="sidebar">
        <div className="side-brand">
          ...
          <div>
            ...
            <small>{me.site_label || "众卿任务台"}</small>
          </div>
        </div>
      ...
      <main className="main">
        ...
        {page === "ops" && <Operations internalOn={internalOn} />}
        ...
        {page === "infra" && <Infra />}
        {page === "internal" && internalOn && <InternalHub />}
