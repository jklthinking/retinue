...
EXPECTED_ROUTES = {
    ...
    ("/api/inbox", ("GET",), "get_inbox", ("require_auth", "get_db", "get_db")),
    ...
    ("/api/skills/sync", ("POST",), "sync_runtime_skills", ("require_auth", "get_db", "get_db")),
    ...
    ("/api/distill/candidates", ("GET",), "get_distill_candidates", ("require_auth", "get_db", "get_db")),
    ("/api/distill/candidates", ("POST",), "post_distill_candidate", ("require_auth", "get_db", "get_db")),
    ("/api/distill/candidates/{candidate_id}", ("GET",), "get_distill_candidate", ("require_auth", "get_db", "get_db")),
    ("/api/distill/candidates/{candidate_id}/promote", ("POST",), "post_distill_promote", ("require_auth", "get_db", "get_db")),
    ("/api/distill/candidates/{candidate_id}/reject", ("POST",), "post_distill_reject", ("require_auth", "get_db", "get_db")),
